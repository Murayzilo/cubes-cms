...
class Application_Model_DbTable_CmsServices extends Zend_Db_Table_Abstract {
     ...
     */
     public function deleteService($id) {
       //fetch order number for new service
...
/**
	 ...
	 *			),
	 *			'orders' => array(
	 *				'order_number' => 'ASC', // key is column , if value is ASC then ORDER BY ASC,
	 *				'title' => 'DESC', // key is column, if value is DESC then ORDER BY DESC
	 *			),
