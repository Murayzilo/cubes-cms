    ...
    public function insertPhotoGallery($photoGallery) {
       //fetch order number of new photoGallery
          ...
          $select->order('order_number DESC');
           ...
           if ($photoGalleryWithBiggestOrderNumber instanceof Zend_Db_Table_Row) {        // implementira interface array accessable, mozemo da pristupamo kao u nizu   
               $photoGallery['order_number'] = $photoGalleryWithBiggestOrderNumber['order_number'] + 1;
        } else {
          //table was empty, we are insertinf first photoGallery
...
//        /**
//     * 
//     * @param array $photoGalleries
//     * @return int number of active photoGalleries
//     */
//    public function activePhotoGalleries($photoGalleries) {
//        $activePhotoGalleries = 0;
//        foreach ($photoGalleries as $photoGallery) {
//            if ($photoGallery['status'] == self::STATUS_ENABLED) {
//                $activePhotoGalleries ++;
//            }
//        }
//        return $activePhotoGalleries;
//    }
//
//    /**
//     * 
//     * @param array $photoGalleries
//     * @return int total number of photoGalleries
//     */
//    public function totalPhotoGalleries($photoGalleries) {
//        $totalNumberOfPhotoGalleries = 0;
//
//        foreach ($photoGalleries as $photoGallery) {
//            $totalNumberOfPhotoGalleries ++;
//        }
//
//
//        return $totalNumberOfPhotoGalleries;
//    }
