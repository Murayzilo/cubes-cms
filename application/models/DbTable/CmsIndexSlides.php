    ...
    public function insertIndexSlide($indexSlide) {
       //fetch order number of new indexSlide
          ...
          $select->order('order_number DESC');
           ...
           if ($indexSlideWithBiggestOrderNumber instanceof Zend_Db_Table_Row) {        // implementira interface array accessable, mozemo da pristupamo kao u nizu   
               $indexSlide['order_number'] = $indexSlideWithBiggestOrderNumber['order_number'] + 1;
        } else {
          //table was empty, we are insertinf first indexSlide
...
//        /**
//     * 
//     * @param array $indexSlides
//     * @return int number of active indexSlides
//     */
//    public function activeIndexSlides($indexSlides) {
//        $activeIndexSlides = 0;
...
//            }
//        }
//        return $activeIndexSlides;
//    }
//
//    /**
//     * 
//     * @param array $indexSlides
//     * @return int total number of indexSlides
//     */
//    public function totalIndexSlides($indexSlides) {
//        $totalNumberOfIndexSlides = 0;
//
//        foreach ($indexSlides as $indexSlide) {
//            $totalNumberOfIndexSlides ++;
//        }
//
//
//        return $totalNumberOfIndexSlides;
//    }
        ...
        foreach ($filters as $field => $value) {
            ...
            switch ($field) {
                ...
                case 'description_search':
                    ...
                    $select->where('description_type LIKE ?', '%' . $value . '%');
                    break;
